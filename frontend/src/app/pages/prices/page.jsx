export default function Prices() {
  return (
    <>
      <div>
        <h1 className="text-center text-7xl font-bold">Planes</h1>
      </div>
        ...
        <table className="w-96 m-2 p-2 border-2 border-solid text-center">
          <thead>
            <tr className="flex flex-col">
              ...
              <td className="text-center text-6xl font-bold text-blue-800">0 Є</td>
            </tr>
          </thead>
        ...
        <table className="w-96 m-2 p-2 border-2 border-solid shadow-lg shadow-blue-900 text-center">
          <thead>
            <tr className="flex flex-col">
              ...
              <td className="text-center text-6xl font-bold text-blue-800">1 Є</td>
            </tr>
          </thead>
          <tbody className="text-start">
            <tr>
